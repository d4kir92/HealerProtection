...
function HealerProtection:InitSetting()
	HealerProtection:SetVersion(AddonName, 135923, "1.2.29")
	...
	hpset = HealerProtection:CreateFrame(
		{
			...
			["sw"] = 520,
			["sh"] = 520,
			["title"] = string.format("HealerProtection |T135923:16:16:0:0|t by |cff3FC7EBD4KiR |T132115:16:16:0:0|t v|cff3FC7EB%s", "1.2.29")
		}
	)
