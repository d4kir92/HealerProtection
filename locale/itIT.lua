...
D4:AddTrans("itIT", "showonlyenglish", "Mostra solo in inglese")
D4:AddTrans("itIT", "showonlytranslation", "Mostra solo la traduzione")
D4:AddTrans("itIT", "visibility", "Visibilità")
D4:AddTrans("itIT", "extras", "Extra")
D4:AddTrans("itIT", "NEARDEATHPercentage", "Se sotto %s%% Salute, pubblica il messaggio")
D4:AddTrans("itIT", "OOMPercentage", "Se sotto %s%% Mana, pubblica il messaggio")
